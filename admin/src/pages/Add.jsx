...
const Add = ({ token }) => {
  ...
  const [description, setDescription] = useState("");
  const [price, setPrice] = useState("");
  const [category, setCategory] = useState("Katyani Organics");
  const [bestseller, setBestseller] = useState(false);
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div>
            ...
            <select
              ...
              onChange={(e) => setCategory(e.target.value)}
            >
              <option>Katyani Organics</option>
              <option>Honey</option>
...
//       <label>
//         <input type="checkbox" onChange={() => setBestseller(!bestseller)} /> Bestseller
//       </label>
